...
logging/log_parser.cpp          Structured text log parsing
logging/logger.cpp              Async batched thread-safe line logger
net/net_packet.cpp              Packet send/recv plus PACKET_SEND/PACKET_RECV protocol logs
