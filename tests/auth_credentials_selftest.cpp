...
int main()
{
    try
    {
        require(cyber::auth_derive_client_key(cyber::EntityId::client1, "123456") ==
                    0x0059EF3DB7CB8C8DULL,
                "Client1 derived key mismatch");
        require(cyber::auth_derive_client_key(cyber::EntityId::client2, "admin123") ==
                    0x006A73A4EBE9C564ULL,
                "Client2 derived key mismatch");
        require(cyber::auth_derive_client_key(cyber::EntityId::client3, "hehe12345") ==
                    0x0057EF9D5F45AB7BULL,
                "Client3 derived key mismatch");
        require(cyber::auth_derive_client_key(cyber::EntityId::client4, "&wxh@147") ==
                    0x00EC3EB766D59086ULL,
                "Client4 derived key mismatch");
        require(cyber::auth_derive_client_key(cyber::EntityId::client1, "wrong") !=
                    0x0059EF3DB7CB8C8DULL,
